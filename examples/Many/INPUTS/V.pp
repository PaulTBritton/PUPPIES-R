...
scatterbar(plotname="OUTPUTS/ICPS.tiff",filter="*ICPS")
...
scatterbar(plotname="OUTPUTS/booster.tiff",filter="B_*")
...
scatterbar(plotname="OUTPUTS/corestage.tiff",filter="CS_*")
