setattr(name="Easy Model",iterations=555,seed=1)
#print("easymodel.p")
#print(ls(parent.frame()))
E5 <- unifD(a=4,b=6)
#print(E5)
E3 <- 3
A3 <- triaD(a=2,b=3,c=4)
B5 <- betaD(alpha=A3,beta=6)
B4 <- empeD(empfile="data/B4.dat")
...
M1 <- S1*5.00E-01
testM <- betaD(N=77,alpha=A3,beta=6)
pplot(plotname="Easyplot1.tiff",plist=plotlist(B4,B5,testM,M2,M1))
elist <- plotlist(B4,B5,M2,M1)
pplot(plotname="Easyplot2.tiff",plist=elist)
eventstoplot <- plotlist("B4 name"=B4,B5,"M2 descr"=M2,M1)
pplot(plotname="Easyplot3.tiff",plist=eventstoplot) #,filter="M?|S?")
#print(ls())
