...
scatterbars(plotname="OUTPUTS/ICPS.tiff",filter="*ICPS")
...
scatterbars(plotname="OUTPUTS/booster.tiff",filter="B_*")
...
scatterbars(plotname="OUTPUTS/corestage.tiff",filter="CS_*")
